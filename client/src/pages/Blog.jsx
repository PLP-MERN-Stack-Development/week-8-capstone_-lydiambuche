  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        <h2 className="my-5 max-w-lg truncate mx-auto">{data.subTitle ? data.subTitle : data.title}</h2>
      ...
      <div className="rich-text mx-5 max-w-5xl md:mx-auto my-10 mt-6">
            ...
            {comments.map((item, index) => (
              <div key={index} className="relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded text-gray-600">
                <div className="flex items-center gap-2 mb-2">
                  <img className="w-6" src={assets.user_icon} alt="icon"/>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={addComment} className="flex flex-col items-start gap-4 max-w-lg">
            ...
            <input onChange={(e)=> setName(e.target.value)} placeholder="Name" required className="w-full p-2 border border-gray-300 rounded outline-none" type="text" value={name}/>
